...
class Gii < Formula
  ...
  if Hardware.is_64_bit?
    url "https://github.com/jkawamoto/gii/releases/download/0.1.0/gii_0.1.0_darwin_amd64.zip"
    sha256 "eea13698eed81db94ecdec6197258d925ebb262162bd73f3342a2cd567bd9e8a"
  else
    url "https://github.com/jkawamoto/gii/releases/download/0.1.0/gii_0.1.0_darwin_386.zip"
